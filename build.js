...
/* ---- masthead ---- */
.tglbar{padding:16px 0;display:flex;justify-content:flex-start}
...
.tgl{
  display:block;width:70px;height:38px;padding:0;position:relative;
...
<div class="tglbar"><button class="tgl" id="theme" role="switch" aria-checked="false" aria-label="Dark mode">
